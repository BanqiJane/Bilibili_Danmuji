...
public class User implements Serializable{
	...
	public User(Long uid, String uname, String face, Long silver, Integer gold, Integer achieve, Short vip, Short svip,
			Short user_level, Short user_next_level, Long user_Integerimacy, Long user_next_Integerimacy, Long user_level_rank,
			Short user_charged, Integer billCoin) {
		super();
		this.uid = uid;
		this.uname = uname;
		this.face = face;
	...
	public Long getUser_level_rank() {
		return user_level_rank;
	}


	public void setUser_level_rank(Long user_level_rank) {
		this.user_level_rank = user_level_rank;
	}
	...
	public String toString() {
		return "User [uid=" + uid + ", uname=" + uname + ", face=" + face + ", silver=" + silver + ", gold=" + gold
				...
				+ ", user_next_level=" + user_next_level + ", user_Integerimacy=" + user_Integerimacy + ", user_next_Integerimacy="
				+ user_next_Integerimacy + ", user_level_rank=" + user_level_rank + ", user_charged=" + user_charged
				+ ", billCoin=" + billCoin + "]";
	}
